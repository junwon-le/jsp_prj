      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
               ...
               //: Java가 개발한 기술로 객체 찾고 얻을 수 있는 기술.
               Context ctx = new InitialContext();
               //2. JNDI 사용 객체를 사용하여 DBCP에서 연결을 유지하고 잇는 DataSource를 얻기
               DataSource ds = (DataSource)ctx.lookup("java:comp/env/jdbc/dbcp"); //Was마다 이름이 다름 tomcat이 아니면 바뀔 수 있다.
               //3. connection 얻기
