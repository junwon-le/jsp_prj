...
<c:import url="http://localhost/jsp_prj/fragments/bootstrap_css.jsp"></c:import>
<style type="text/css">
...
<body>
   <header data-bs-theme="dark">
      ...
      <c:import url="http://localhost/jsp_prj/fragments/header.jsp"></c:import>
   </header>
   <main>
      <%-- <jsp:include page="../fragments/carousel.jsp"/> --%>
      <c:import url="http://localhost/jsp_prj/fragments/carousel.jsp"></c:import>
  ...
  ================================================== -->
      ...
      <footer class="container">
    	...
    	<c:import url="http://localhost/jsp_prj/fragments/footer.jsp"></c:import>
      </footer>
   </main>
